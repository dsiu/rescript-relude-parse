...
describe("ReludeParse_IPv6", () => {
  ...
  testAll(
    ...
    list{
      ...
      ("000:000:000:000:000:000:000:001", IPv6.unsafeFromInts(0, 0, 0, 0, 0, 0, 0, 1), 31),
      ("0000:0000:0000:0000:0000:0000:0000:0001", IPv6.unsafeFromInts(0, 0, 0, 0, 0, 0, 0, 1), 39),
      (
      ...
      ("2001:db8::ff00:42:8329", IPv6.unsafeFromInts(8193, 3512, 0, 0, 0, 65280, 66, 33577), 22),
      ("2001::8329", IPv6.unsafeFromInts(8193, 0, 0, 0, 0, 0, 0, 33577), 10),
      ("ffff::ffff", IPv6.unsafeFromInts(65535, 0, 0, 0, 0, 0, 0, 65535), 10),
      ("ffff:ffff::ffff", IPv6.unsafeFromInts(65535, 65535, 0, 0, 0, 0, 0, 65535), 15),
      ("ffff:ffff:ffff::ffff", IPv6.unsafeFromInts(65535, 65535, 65535, 0, 0, 0, 0, 65535), 20),
      (
      ...
      (
        ...
        IPv6.unsafeFromInts(65535, 65535, 65535, 65535, 65535, 65535, 0, 65535),
        35,
      ),
      (
        "ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff",
        IPv6.unsafeFromInts(65535, 65535, 65535, 65535, 65535, 65535, 65535, 65535),
        39,
      ),
      (
        "ffff::ffff:ffff:ffff:ffff:ffff:ffff",
        IPv6.unsafeFromInts(65535, 0, 65535, 65535, 65535, 65535, 65535, 65535),
        35,
      ),
      (
        "ffff::ffff:ffff:ffff:ffff:ffff",
  ...
  testAll(
    ...
    ((str, pos)) => testParseFail(\"<*"(IPv6.parser, P.eof), str, pos),
  )
